...
def load_model(config_name, checkpoint_path, device="cuda"):
    ...
    # PATCH (utilisateur / 16GB VRAM): charger sur CPU puis caster en bf16. Charger en
    # fp32 sur GPU (map_location=device) + model.to(device) consommait ~4.9 GB.
    # En bf16 le codec passe à ~2.5 GB.
    ...
    # PATCH (utilisateur / 16GB VRAM): `assign=True` + weight_norm matérialise le poids
    # en double (~4 GB). Sans assign, le codec bf16 tient en ~1.4 GB.
