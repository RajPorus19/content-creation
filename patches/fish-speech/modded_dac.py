...
class Transformer(nn.Module):
    def __init__(self, config: ModelArgs) -> None:
        ...
        # PATCH (utilisateur / 16GB VRAM): le masque causal était codé en dur à 32768×32768
        # (≈ 1.07 GB de booléens × 3 blocs = 3.2 GB !). On utilise block_size
        # (8192 pour l'encodeur, 2048 pour le quantizer) qui borne réellement la
        # longueur de séquence du codec.
